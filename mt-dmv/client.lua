...
RegisterNetEvent('mt-dmv:client:AbrirMenu', function()
    exports['qb-menu']:openMenu({
      {
        header = "Escola de condução",
        isMenuHeader = true,
      },
      {
        header = "Começar teste prático de carros",
      ...
      {
        header = "Começar teste prático de camiões",
      ...
      {
        header = "Começar teste prático de motas",
...
RegisterNetEvent('mt-dmv:startdriver', function()
    ...
    QBCore.Functions.SpawnVehicle(Config.VehicleModels.driver, function(veh)
        ...
        CurrentVehicle = veh
        QBCore.Functions.Notify('Estás a tirar o teste de condução')
...
function StopDriveTest(success)
    ...
    if success then
      ...
      QBCore.Functions.Notify('Passas-te o teste!')
      QBCore.Functions.DeleteVehicle(veh)
      CurrentTest = nil
    elseif success == false then
      TriggerServerEvent('mt-dmv:driverpaymentfailed')
      QBCore.Functions.Notify('Falhaste o teste!')
      CurrentTest = nil
                ...
                for k,v in pairs(Config.SpeedLimits) do
                    ...
                    tooMuchSpeed = true
                        if not IsAboveSpeedLimit then
                            ...
                            QBCore.Functions.Notify('A dirigir muito rapido',"error")
